    ...
    >
      {photos.map((photo, index) => (
        <button
          ...
          className="group relative min-h-11 overflow-hidden rounded-2xl bg-[linear-gradient(180deg,rgba(8,14,28,0.92),rgba(4,8,18,0.98))] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
